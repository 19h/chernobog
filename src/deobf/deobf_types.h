...
struct deobf_ctx_t
{
    ...
    deobf_ctx_t()
        : mba(nullptr), cfunc(nullptr), func_ea(BADADDR), detected_obf(OBF_NONE), blocks_merged(0),
          branches_simplified(0), strings_decrypted(0), consts_decrypted(0),
          expressions_simplified(0), indirect_resolved(0), mba_simplified(0), chains_simplified(0),
          opaque_jumps_resolved(0), z3_consts_recovered(0), peephole_opts(0)
    {
    }
};
