...
inline bit_liveness_transfer_t transfer_bit_liveness(uint64_t incoming, uint64_t read_mask,
                                                     uint64_t write_mask)
{
    return {
...
propagate_dependency_liveness(size_t variable_count, const std::vector<uint8_t> &observable,
