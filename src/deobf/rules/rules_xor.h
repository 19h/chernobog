...
class Xor_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(bor(x_0(), x_1()), band(x_0(), x_1())); }
...
class Xor_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bor(bnot(bor(x_0(), x_1())), band(x_0(), x_1())); }
...
class Xor_FactorRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bor(band(x_0(), x_1()), bnot(bor(x_0(), x_1()))); }
...
class Xor_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bxor(bnot(x_0()), bnot(x_1())); }
...
class Xor_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bxor(x_0(), c_0()); }
...
class Xor_Rule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bxor(x_0(), x_0()); }
