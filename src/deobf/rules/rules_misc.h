...
class Bnot_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(bnot(x_0())); }

    AstPtr get_replacement() const override { return x_0(); }
};
...
class Bnot_HackersDelightRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(neg(x_0()), c_1()); }

    AstPtr get_replacement() const override { return bnot(x_0()); }
};
...
class Bnot_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(sub(x_0(), c_1())); }

    AstPtr get_replacement() const override { return neg(x_0()); }
};
...
class Bnot_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(add(x_0(), c_1())); }

    AstPtr get_replacement() const override { return sub(neg(x_0()), c_2()); }
};
...
class BnotXor_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bxor(bnot(x_0()), x_1()); }

    AstPtr get_replacement() const override { return bnot(bxor(x_0(), x_1())); }
};
...
class BnotXor_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bxor(x_0(), bnot(x_1())); }
...
class Neg_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(neg(x_0())); }
...
class Neg_HackersDelightRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(bnot(x_0()), c_1()); }
...
class NegSub_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(sub(x_0(), x_1())); }

    AstPtr get_replacement() const override { return sub(x_1(), x_0()); }
};
...
class NegAdd_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(add(x_0(), x_1())); }

    AstPtr get_replacement() const override { return sub(neg(x_0()), x_1()); }
};
...
class Neg_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(c_0()); }

    AstPtr get_replacement() const override { return c_0(); }
...
class Mul_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(x_0(), c_0()); }
...
class Mul_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(x_0(), c_1()); }
...
class Mul_Rule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(x_0(), c_2()); }

    AstPtr get_replacement() const override { return add(x_0(), x_0()); }
...
class Mul_Rule_4 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(x_0(), make_named_const("c_minus_1")); }
...
class Mul_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(neg(x_0()), x_1()); }

    AstPtr get_replacement() const override { return neg(mul(x_0(), x_1())); }
};
...
class Mul_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return mul(neg(x_0()), neg(x_1())); }

    AstPtr get_replacement() const override { return mul(x_0(), x_1()); }
};
...
class Const_AddZero : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(x_0(), c_0()); }
...
class Const_ZeroAdd : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(c_0(), x_0()); }
...
class Const_OrSelf : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bor(x_0(), x_0()); }
...
class Const_AndSelf : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(x_0(), x_0()); }
