...
class Sub_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(add(x_0(), bnot(x_1())), c_1()); }
...
class Sub_HackersDelightRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(add(bnot(x_0()), x_1())); }
...
class Sub_HackersDelightRule_4 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override
    {
        return add(neg(mul(c_2(), band(bnot(x_0()), x_1()))), bxor(x_0(), x_1()));
    }
...
class Sub1_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(add(bnot(x_0()), c_1())); }

    AstPtr get_replacement() const override { return sub(x_0(), c_1()); }
};
...
class Sub1_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(x_0(), make_named_const("c_minus_1")); }
...
class Sub_NegRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(x_0(), neg(x_1())); }
...
class Sub_NegRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(neg(x_1()), x_0()); }
...
class Sub_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(x_0(), c_0()); }
...
class Sub_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(x_0(), x_0()); }
...
class Sub_Rule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(c_0(), x_0()); }
...
class Sub_AddCancelRule : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(add(x_0(), x_1()), x_1()); }
