...
class Add_HackersDelightRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_replacement() const override { return add(x_0(), x_1()); }
};
...
class Add_HackersDelightRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(bor(x_0(), x_1()), band(x_0(), x_1())); }
...
class Add_CarryFreeOrRule : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(x_0(), band(x_1(), bnot(x_0()))); }

    AstPtr get_replacement() const override { return bor(x_0(), x_1()); }
};
...
class Add_OrNotCarryRule : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(add(bor(x_1(), bnot(x_0())), x_0()), c_1()); }

    AstPtr get_replacement() const override { return band(x_0(), x_1()); }
};
...
class Add_DisjointAndRule : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_replacement() const override { return x_1(); }
};
...
class Add_OllvmRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(band(x_0(), x_1()), bor(x_0(), x_1())); }
...
class Add_OllvmRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(bnot(add(bnot(x_0()), bnot(x_1()))), c_1()); }

    AstPtr get_replacement() const override { return add(add(x_0(), x_1()), c_2()); }
};
...
class Add_OllvmRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(add(add(bnot(x_0()), bnot(x_1())), c_2())); }
...
class Add_OllvmRule_4 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override
    {
        return add(add(bnot(bor(bnot(x_0()), bnot(x_1()))), bnot(bor(x_0(), bnot(x_1())))), c_1());
    }

    AstPtr get_replacement() const override { return add(x_1(), c_1()); }
};
...
class Add_SpecialConstantRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_replacement() const override { return bxor(x_0(), x_1()); }
...
class Add_SpecialConstantRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override
    {
        return add(bxor(x_0(), x_1()),
                   mul(make_named_const("c_minus_2"), band(bnot(x_0()), x_1())));
    }

    AstPtr get_replacement() const override { return sub(x_0(), x_1()); }
...
class Add_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(add(bnot(x_0()), bnot(x_1())), c_2()); }

    AstPtr get_replacement() const override { return neg(add(x_0(), x_1())); }
};
...
class Add_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_replacement() const override { return sub(add(x_0(), x_1()), c_1()); }
};
...
class AddXor_Rule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(add(x_0(), x_1()), bxor(x_0(), x_1())); }

    AstPtr get_replacement() const override { return mul(c_2(), band(x_0(), x_1())); }
};
...
class AddXor_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(add(x_0(), x_1()), bor(x_0(), x_1())); }
...
class Add_NegRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(x_0(), neg(x_1())); }
...
class Add_NegRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(sub(neg(x_0()), neg(x_1()))); }
...
class Add_NegRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return neg(add(neg(x_0()), neg(x_1()))); }
...
class Add_ComplexRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return add(band(bnot(x_0()), x_1()), bor(x_0(), x_1())); }
