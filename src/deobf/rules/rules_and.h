...
class And_HackersDelightRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return sub(bor(x_0(), x_1()), bxor(x_0(), x_1())); }
...
class And_HackersDelightRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return bnot(bor(bnot(x_0()), bnot(x_1()))); }
...
class And_HackersDelightRule_4 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bxor(x_0(), bnot(x_1())), x_0()); }
...
class And_OllvmRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override
    {
        return band(band(bor(bnot(x_0()), x_1()), bor(x_0(), bnot(x_1()))), bor(x_0(), x_1()));
    }
...
class And_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(x_0(), bor(x_0(), x_1())); }
...
class And_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bor(x_0(), x_1()), x_0()); }
...
class AndBnot_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bnot(x_0()), bnot(x_1())); }

    AstPtr get_replacement() const override { return bnot(bor(x_0(), x_1())); }
};
...
class AndBnot_FactorRule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(x_0(), bnot(x_0())); }
...
class AndBnot_FactorRule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bnot(x_0()), x_0()); }
...
class AndBnot_FactorRule_4 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bxor(x_0(), x_1()), bnot(x_1())); }

    AstPtr get_replacement() const override { return band(x_0(), bnot(x_1())); }
};
...
class AndOr_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(bor(x_0(), x_1()), bor(x_0(), bnot(x_1()))); }
...
class AndXor_FactorRule_1 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(band(x_0(), x_1()), bor(x_0(), x_1())); }
...
class And_Rule_2 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(x_0(), c_0()); }
...
class And_Rule_3 : public PatternMatchingRule
{
  public:
    ...
    AstPtr get_pattern() const override { return band(x_0(), make_named_const("c_minus_1")); }
