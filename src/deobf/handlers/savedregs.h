...
class savedregs_handler_t
{
  ...
  private:
    ...
    static bool resolve_indirect_call(mblock_t *block, minsn_t *call, resolved_call_t *out);
    static void extract_call_args(mblock_t *block, minsn_t *call, resolved_call_t *out);
