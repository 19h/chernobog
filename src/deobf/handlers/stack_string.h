...
class stack_string_handler_t
{
  ...
  private:
    ...
    static bool analyze_byte_sequence(const std::vector<byte_store_t> &stores, stack_string_t *out);
    ...
    static std::optional<uint8_t> resolve_byte_value(minsn_t *ins, int depth = 0);
