...
const HybridAbiLayout x86_32{HybridAbi::X86_32, "x86-32 stack", 4, true, 0, {}, {}};
const HybridAbiLayout x64_sysv{HybridAbi::X86_64_SYSV,
                               "x86-64 SysV",
                               8,
                               true,
                               0,
                               {RAX_X86_REG_RDI, RAX_X86_REG_RSI, RAX_X86_REG_RDX, RAX_X86_REG_RCX,
                                RAX_X86_REG_R8, RAX_X86_REG_R9},
                               {"rdi", "rsi", "rdx", "rcx", "r8", "r9"}};
const HybridAbiLayout x64_win{HybridAbi::X86_64_WIN64,
                              "x86-64 Windows",
                              8,
                              true,
                              32,
                              ...
                              {"rcx", "rdx", "r8", "r9"}};
const HybridAbiLayout aapcs32{HybridAbi::AAPCS32,
                              "AAPCS32",
                              4,
                              false,
                              0,
                              ...
                              {"R0", "R1", "R2", "R3"}};
const HybridAbiLayout aapcs64{HybridAbi::AAPCS64,
                              "AAPCS64",
                              8,
                              false,
                              0,
...
const HybridAbiLayout riscv64{HybridAbi::RISCV64,
                              "RISC-V LP64",
                              8,
                              false,
                              0,
...
const HybridAbiLayout cortex_m{HybridAbi::CORTEX_M,
                               "Cortex-M AAPCS",
                               4,
                               false,
                               0,
...
const HybridAbiLayout hexagon{
    ...
    false,
    0,
    {RAX_HEX_R(0), RAX_HEX_R(1), RAX_HEX_R(2), RAX_HEX_R(3), RAX_HEX_R(4), RAX_HEX_R(5)},
    {"R0", "R1", "R2", "R3", "R4", "R5"}};
...
HybridAbi hybrid_abi_for_arch(HybridArch arch, bool windows_x64)
{
    ...
    case HybridArch::X86_32:
        return HybridAbi::X86_32;
    case HybridArch::X86_64:
        return windows_x64 ? HybridAbi::X86_64_WIN64 : HybridAbi::X86_64_SYSV;
    case HybridArch::ARM32:
        return HybridAbi::AAPCS32;
    case HybridArch::ARM64:
        return HybridAbi::AAPCS64;
    case HybridArch::RISCV64:
        return HybridAbi::RISCV64;
    case HybridArch::CORTEX_M:
        return HybridAbi::CORTEX_M;
    case HybridArch::HEXAGON:
        return HybridAbi::HEXAGON;
    default:
        return HybridAbi::UNKNOWN;
    }
}
...
const HybridAbiLayout &hybrid_abi_layout(HybridAbi abi)
{
    switch (abi)
    {
    case HybridAbi::X86_32:
        return x86_32;
    case HybridAbi::X86_64_SYSV:
        return x64_sysv;
    case HybridAbi::X86_64_WIN64:
        return x64_win;
    case HybridAbi::AAPCS32:
        return aapcs32;
    case HybridAbi::AAPCS64:
        return aapcs64;
    case HybridAbi::RISCV64:
        return riscv64;
    case HybridAbi::CORTEX_M:
        return cortex_m;
    case HybridAbi::HEXAGON:
        return hexagon;
    default:
        return unknown;
    }
...
const char *hybrid_abi_name(HybridAbi abi) { return hybrid_abi_layout(abi).name; }
                                                         ...
                                                         uint64_t stack_size)
{
    ...
    const bool stack_mapped = stack_size != 0 && checked_add(stack_base, stack_size, &stack_end) &&
    ...
    for (size_t index = 0; index < count; ++index)
    {
        ...
        {
        case 0:
            item = {0, HybridSeedValueKind::ZERO};
            break;
        case 1:
            item = {1, HybridSeedValueKind::ONE};
            break;
        case 2:
            item = {std::numeric_limits<uint16_t>::max(), HybridSeedValueKind::U16_MAX};
            break;
        case 3:
            item = {uint64_t(std::numeric_limits<int16_t>::max()), HybridSeedValueKind::I16_MAX};
            break;
        case 4:
            item = {uint64_t(int64_t(std::numeric_limits<int16_t>::min())),
                    HybridSeedValueKind::I16_MIN};
            break;
        case 5:
            item = {image_lo, HybridSeedValueKind::IMAGE_POINTER};
            break;
        case 6:
        {
            if (!stack_mapped)
            ...
            if (!checked_add(stack_middle, slot * 0x100, &pointer) || pointer >= stack_end)
                item = {mixed, HybridSeedValueKind::MIXED};
            else
                                         ...
                                         uint64_t stack_size, bool big_endian)
{
    ...
    if (input.stack_arg_offset != 0 && input.stack_arg_offset != layout.stack_argument_offset)
    {
    ...
    for (; positional < input.args.size() && abi_position < layout.argument_registers.size();
    ...
    for (const EmuInput::ArgOverride &argument : input.arg_overrides)
        if (argument.index < layout.argument_registers.size())
            result.registers.push_back({layout.argument_registers[argument.index], argument.value});
    ...
    const uint64_t return_slot = layout.return_address_on_stack ? layout.pointer_size : 0;
    ...
    {
        uint64_t next = 0;
        if (destination < stack_base || !checked_add(destination, layout.pointer_size, &next) ||
            next > stack_end)
        {
        ...
        for (size_t byte = 0; byte < size_t(write.size) && byte < write.bytes.size(); ++byte)
        {
            const size_t shift_index = big_endian ? size_t(layout.pointer_size) - 1 - byte : byte;
