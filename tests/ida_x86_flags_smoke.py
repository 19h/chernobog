...
CASES = {
    "vf_o": False, "vf_no": True, "vf_b": False, "vf_ae": True,
    "vf_e": True, "vf_ne": False, "vf_be": True, "vf_a": False,
    "vf_s": False, "vf_ns": True, "vf_p": True, "vf_np": False,
    "vf_l": False, "vf_ge": True, "vf_le": True, "vf_g": False,
    "vf_cmc": True, "vf_inc_cf": True, "vf_stc_zf": True,
    "vf_bswap": True,
    "vf_long_window": True if int(os.environ.get("CHERNOBOG_IDA_FLAG_SCAN_DEPTH", "8")) >= 41 else None,
    "vf_overflow": True, "vf_ah": True, "vf_zero_extend": True,
    "vf_set_false": True, "vf_set_true": True, "vf_cmov_false32": True,
    "vf_unknown_input": None, "vf_unknown_carry": None,
    "vf_unknown_count": None, "vf_alias_unknown": None,
    "vf_call_barrier": None, "vf_alternate_entry": None,
}
JCC = {getattr(ida_allins, "NN_" + n) for n in
       ("jo", "jno", "jb", "jnb", "jz", "jnz", "jbe", "ja",
        "js", "jns", "jp", "jnp", "jl", "jnl", "jle", "jnle",
        "jg", "jge", "jae", "jc", "je", "jne", "jna", "jnae",
        "jnbe", "jnc", "jng", "jnge", "jpe", "jpo")}
...
try:
    ...
    for name, expected in CASES.items():
        ...
        comment = "\n".join(filter(None, (
            ida_bytes.get_cmt(insn.ea, True), ida_bytes.get_cmt(insn.ea, False))))
        ...
        records.append({"name": name, "expected": expected, "ea": int(insn.ea),
                        "edges": edges, "comment": comment,
