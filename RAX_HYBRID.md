...
| `chernobog_vm_temporal_string_state(ticket)` | Re-snapshot and compare exact input bytes, metadata, profile and model names for source navigation; no execution |
